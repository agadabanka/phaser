...
A Studio **brick** providing capability **`texturing`**. Scaffolded by the Lego
...
node studio/lego/dispatch.mjs texturing    # ensure-vendor + run the validator → ACCEPT/REJECT
```
