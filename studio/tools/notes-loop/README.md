...
A Studio **brick** providing capability **`feedback`**. Scaffolded by the Lego
...
node studio/lego/dispatch.mjs feedback    # ensure-vendor + run the validator → ACCEPT/REJECT
```
